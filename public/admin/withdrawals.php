                                    ...
                                    <div style="font-size: 11px; color: var(--text-muted);">
                                        ...
                                        <?php if ($req['payment_proof']): ?>
                                            <div style="margin-top: 5px;">
                                                <a href="<?= site_url('public/file.php?type=payout&file=' . urlencode($req['payment_proof'])) ?>" target="_blank" style="color: var(--primary); font-weight: 600; text-decoration: none;">
